	...
	<div id="liste" style="border:0px solid gray; padding:4px; [{*height:100%; width:100%;*}]width:59%; height:96%; overflow-y:scroll; float:left;">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				...
				<td class="listheader">[{ oxmultilang ident="GENERAL_SUMTOTAL" }]</td>
			</tr>
			[{foreach item=aVoucher from=$aVouchers}]
				...
				<tr>
					...
					<td class="[{ $listclass }]">[{if $aVoucher.oxtotalordersum != ""}][{$aVoucher.oxtotalordersum|string_format:"%.2f"}][{/if}]</td>
				</tr>
			[{/foreach}]
		</table>
	</div>
